...
function createRouter(init) {
  ...
  async function startRedirectNavigation(state, redirect, _temp) {
    ...
    if (ABSOLUTE_URL_REGEX$1.test(redirect.location) && isBrowser) {
...
function RouterProvider(_ref) {
  ...
  let [state, setStateImpl] = React$1.useState(router.state);
  let {
    v7_startTransition
  } = future || {};
  ...
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator
  }, state.initialized ? /*#__PURE__*/React$1.createElement(DataRoutes, {
