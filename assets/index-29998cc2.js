...
const remotesMap = {
'product-mfe':{url:'https://tminhduc2811.github.io/product-mfe/assets/product-mfe-entry.js',format:'esm',from:'vite'},
  'cart-mfe':{url:'https://tminhduc2811.github.io/cart-mfe/assets/cart-mfe-entry.js',format:'esm',from:'vite'},
  'about-mfe':{url:'https://tminhduc2811.github.io/about-mfe/assets/about-mfe-entry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                    return {
                        'react':{'18.2.0':{get:()=>get$2('./__federation_shared_react.js', remoteFrom), loaded:1}},'react-dom':{'18.2.0':{get:()=>get$2('./__federation_shared_react-dom.js', remoteFrom), loaded:1}},'react-router-dom':{'6.14.2':{get:()=>get$2('./__federation_shared_react-router-dom.js', remoteFrom), loaded:1}},'zustand':{'4.4.1':{get:()=>get$2('./__federation_shared_zustand.js', remoteFrom), loaded:1}}
                    }
                };
...
const Header = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 bg-white border-b flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-xl flex justify-between items-center w-full mx-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative", id: "cart-btn", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            width: "19",
...
const __federation_var_aboutmfeApp = await __federation_method_getRemote("about-mfe" , "./App");
 let AboutApp = __federation_method_unwrapDefault(__federation_var_aboutmfeApp); 
...
const VueAboutApp = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "vue-app" });
};
