...
const moduleMap = {'react':{get:()=>()=>__federation_import('./__federation_shared_react.js'),import:true},'react-dom':{get:()=>()=>__federation_import('./__federation_shared_react-dom.js'),import:true},'react-router-dom':{get:()=>()=>__federation_import('./__federation_shared_react-router-dom.js'),import:true},'zustand':{get:()=>()=>__federation_import('./__federation_shared_zustand.js'),import:true}};
